...
cherryApp.controller('TextDetailController', ['$scope','$routeParams', 'HelperService','SelectedText','SelectedIntention','AppLabels',
function ($scope,$routeParams, HelperService,SelectedText,SelectedIntention,AppLabels) {
