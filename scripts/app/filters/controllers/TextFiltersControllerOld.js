angular.module('app/filters/TextFiltersControllerOld', [])

.factory('FILTER_LABELSOld', function() {
...
.controller('TextFiltersControllerOld', ['$scope','filtersSvc','currentUser', 'FILTER_LABELS','currentRecipientSvc','currentLanguage',
