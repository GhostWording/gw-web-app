...
.factory('intentionsSvc', ['$q', 'areasSvc', 'cacheSvc', 'serverSvc','currentLanguage', function($q, areasSvc, cacheSvc, serverSvc,currentLanguage) {
  ...
  var service = {
    ...
    setIntentionId: function(intentionId) {
      currentId = intentionId;
    },
