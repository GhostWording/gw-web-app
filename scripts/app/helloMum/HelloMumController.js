...
.controller('HelloMumController', ['$scope','randomHelperSvc','textsSvc','currentLanguage','$q','helloMumSvc',
function($scope,randomHelperSvc,textsSvc,currentLanguage,$q,helloMumSvc) {

  // Get the slugs of the relevant intentions
  var arrayOfIntentionsWithTexts = helloMumSvc.getQualifiedIntentionsSlugs();

  // TODO : adjust userWeight properties according to user preferences
  // .....
  ...
  var culture = currentLanguage.currentCulture(); // could use 'en-GB' instead
